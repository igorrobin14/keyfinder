...
###
 - ``` uuid_persos.h ``` - Fichier contenant la définition des **UUIDs** personnalisés
...
## Ce qui a été mis en œuvre
 - Création **d'UUIDs personnalisés** entre ```0x1400``` et ```0x1800``` (ex : ```0x1401```, ```0x1481```, etc)
 ...
 - Envoi d'une valeur (42) **sur le téléphone depuis le keyfinder** lors de l'appui sur un **bouton présent sur le keyfinder** (bouton 1)
...
## Informations utiles
 ...
 - Afin d'envoyer la valeur 42 sur le téléphone, il faut rester appuyé sur le bouton 1 au moins 0.5 s pour éviter un relâchement trop soudain qui ne permet visiblement pas d'envoyer la valeur
